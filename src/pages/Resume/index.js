    ...
    return (
        <div className="page" id="resume">
            <div className="resume-content">
                ...
                <p>Pero no todo es tecnología en mi vida. Cuando no estoy inmerso en líneas de código o desentrañando los misterios de la seguridad web, encuentro mi escape en el futsal deporte que me apasiona y practico con regularidad.</p>
                <p>He trabajado en equipo, liderando y colaborando, lo que me ha dotado de una búsqueda de resultados satisfactorios y eficientes. La innovación y la creación tecnológica es algo que me apasiona, y estoy decidido a ser la mejor versión de mí mismo en este emocionante trayecto.</p>
                <p>Estoy listo para el próximo capítulo en mi camino, y mi objetivo es fusionar mi pasión por la tecnología con mi destreza en seguridad para enfrentar los desafíos que estén por llegar. Si estás buscando un talento apasionado y versátil que pueda aportar experiencia y una visión fresca, ¡estoy aquí y listo para hacer que suceda!</p>
                            </div>
        </div>
    );
};
